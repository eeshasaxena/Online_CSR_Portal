...
.login{
  ...
  <body>
    <ul class="breadcrumb">
      ...
      <li><a href="select.html">User Registration</a></li>
    </ul>
    <form method="post" action="">
    <div id="container">
      <center><h1 id="heading">User Registration Form</h1></center>
      <div id="details">
        <div id="company_details">
          <h2 id="regsitration">Personal Details</h2>
          <div id="data">
            ...
            <br />
            <label>Email</label>
            <input type="text" placeholder="http://www.xyz.com" name="email" required/>
          </div>
        </div>
...
$sql="insert into USER(firstname,lastname,birth_date,contact_number,email,state,area,city,address,pincode,username,password) values('$firstname','$lastname','$birth_date','$contact_number','$email','$state','$area',
