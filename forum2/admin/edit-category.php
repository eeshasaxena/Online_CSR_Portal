...
<body>
                ...
                <div class="panel-heading">
                 ...
                 <div class="panel-body">
                   <form method="POST">
                        ...
                        $cat_id = $_GET['cat_id'];
                        $sel = $con->prepare("SELECT * from category where cat_id=:cat_id");
					    $sel->bindParam(":cat_id", $cat_id);
					    $sel->execute();
    ...
    if(isset($_POST['submit'])){
      ...
      $cat_id = $_GET['cat_id'];
      $update = $con->prepare("UPDATE category set category=:category where cat_id=:cat_id ");
