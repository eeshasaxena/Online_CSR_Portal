...
<body>
    ...
    <div class="signupbox">
        <div class="boxone">
            <span id="create">Create Projects </span>
        </div>
        ...
        <br>
            <form action="includes/createCampaign.inc.php" method="POST" enctype="multipart/form-data">
                <input type="text" name="campaignName" placeholder="Project name" required><br><br>
                ...
                <input type="tel" name="phone" placeholder="Phone: 98********" pattern="[0-9]{10}" required><br>
                <!-- to-do upload file -upload image only-->
                <span id="campaignImage">Upload image of campaign</span> 
                <input type="file" name="campaignPhoto" accept="image/*"><br><br>
                <input type="checkbox" required><span id="agreeterms"> Agree all terms and conditions</span><br><br><br>
                <input type="hidden" name="approval" value="1">
                <input type="submit" name="submit" value="Create Campaign"><br><br>
            </form>
