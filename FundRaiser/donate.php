...
<body>
    ...
    <div class="nav-bar">
       ...
       <!--<div class="btn-login-signup">
            <button type="submit" id="btn-login" onclick="window.location.href='index.php'">HOME</button>
            <button type="submit" id="btn-signup" onclick="window.location.href='signup.php'">LoGIN</button>
        </div> -->
    </div>
        ...
        <div class="bank-details">
            <h2>You can donate in this campaign via Bank Transfer. The Bank details are below:</h2><hr>
                <div class="banks">
                    ...
                    <table>
                        <tr>
                            <th colspan="3">HDFC Bank</th>
                            
                        </tr>
                        <tr>
                            <td>Account Holder</td>
                            <td>:</td>
                            <td>Shraddha Mehta</td>
                        </tr>
                        <tr>
                            <td>Account Number</td>
                            <td>:</td>
                            <td>98765432112345</td>
                        </tr>
                    </table>
                    <br>
                    <table>
            ...
            <br><hr>
            <div class="donor-notice"> Once you submit your details, We will send you an email and you can submit the proof of the donation that you made. By doing this, you will be listed in our donor list as an donor.
